...
[다운로드](https://github.com/ImBada/SearchEverythingForMac/releases/latest/download/SearchEverythingLatest.dmg)
...
개발 임바다 [twitter.com/bd_otk](https://twitter.com/bd_otk)
